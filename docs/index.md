...
Here you can find one MP3 file for each section of the book for direct listening. You can also download these files in one package as [.tar.gz file](https://github.com/feststelltaste/wardley-maps-audiobook/releases/download/v1.0/wardley-maps-audiobook-v1.0.tar.gz (285 MB)) or [.zip file (286 MB)](https://github.com/feststelltaste/wardley-maps-audiobook/releases/download/v1.0/wardley-maps-audiobook-v1.0.zip).
